...
* function switch
  if =creature/paredit= is t, use =paredit= for
  auto pair edit, otherwise use =smartparens=.
  #+BEGIN_SRC emacs-lisp
    (defconst creature/use-paredit t
      "Whether use paredit mode for auto pair edit.
    If t, use `paredit-mode', otherwise use `smartparens-mode'.")

    (defconst creature/use-js2 nil
      "Use `js2-mode' to edit js file when t.
    Otherwise use built-in package `js-mode'.")
  #+END_SRC
...
* auto pair edit
  #+BEGIN_SRC emacs-lisp
    ...
    (cond ((eq creature/use-paredit t)
           ;; enable paredit mode
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (if creature/use-js2
        (progn
          ...
          (add-to-list 'interpreter-mode-alist '("node"   . jss-mode))
          (add-to-list 'interpreter-mode-alist '("nodejs" . jss-mode))
    ...
    (if creature/use-js2
        (add-hook 'rjsx-mode-hook 'jsx-setup)
...
* projectile
  #+BEGIN_SRC emacs-lisp
    (install-packages '(rg projectile))
    (projectile-mode)
