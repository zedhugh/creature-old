...
(evil-global-set-key 'visual [Control-Bracketleft] 'evil-normal-state)
(evil-global-set-key 'normal [Control-Bracketleft] 'evil-normal-state)
(evil-global-set-key 'replace [Control-Bracketleft] 'evil-normal-state)
